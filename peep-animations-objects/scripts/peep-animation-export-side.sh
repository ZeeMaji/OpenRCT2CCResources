# Batch export side scroller style sprites facing east, while automatically flipping east sprites to face west.
...
magick -dispose Background "input-east.psd" -layers coalesce "output.png"
